...
<table id="content_holder" class="ctrl_content" style="margin:50px 0 0 0;" border="0" cellpadding="0" cellspacing="0">
	<tr valign="top">
		<td>
			<?php include('company_control_tab_1.php');?>
		</td>
	</tr>
</table>

<script>
var act_tab = '<?php print $_COOKIE['company_tab'];?>';
var ctrl_id = '';
	ctrl_action = '';
var post_url = 'company_manage.php';
var curr_tab_panel = '';
...
<?php
include("../../public/public_content.php");
