                                            ...
                                            <div class="scroll_holder">
                                                ...
                                                <table class="company_holder company" cellpadding="5" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="title">取消合作</td>
                                                        <td>
                                                            <label for="v_cancelled">
                                                                <input type="checkbox" name="v_cancelled" id="v_cancelled">已取消合作
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="title required">公司简称</td>
                                                        <td>
                                                            <input type="text" name="v_short_name" class="" id="v_short_name">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="title required">公司性质</td>
                                                        <td colspan="3">
                                                            <select id="v_nature" name="v_nature">
                                                                <?php
                                                                foreach ($GLOBALS['category_nature'] as $key => $value){
                                                                    print '<option value="'.$key.'">'.$value.'</option>';
                                                                }
                                                                ?>
                                                            </select>
                                                            <span class="title required">所属行业</span>
                                                            <select id="v_trade" name="v_trade">
                                                                <?php
                                                                foreach ($GLOBALS['category_trade'] as $key => $value){
                                                                    print '<option value="'.$key.'">'.$value.'</option>';
                                                                }
                                                                ?>
                                                            </select>
                                                            <span class="title required">公司规模</span>
                                                            <select id="v_scale" name="v_scale">
                                                                <?php
                                                                foreach ($GLOBALS['category_scale'] as $key => $value){
                                                                    print '<option value="'.$key.'">'.$value.'</option>';
                                                                }
                                                                ?>
                                                            </select>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3"><input type="text" name="v_registered_fund" id="v_registered_fund" style="width:81px;"/>（人民币）
                                                        <span class="title required">联系人</span>
                                                        <input type="text" name="v_contact" id="v_contact" style="width:81px;"/>
                                                        <span class="title required">联系电话(手机)</span>
                                                        <input type="text" name="v_telephone" id="v_telephone" style="width:81px;"/>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3"><input type="text" name="v_fixed_phones" id="v_fixed_phones" />
                                                    ...
                                                    <tr>
                                                        <td class="title">企业情况</td>
                                                        <td colspan="3">
                                                            <textarea name="v_remark" id="v_remark"></textarea>
                                                        </td>
                                                    </tr>
...
<script>
            ...
            success: function (xml) {
                ...
                foreach($GLOBALS['company_fields'] as $key){
                    if($key=="name"){
                        ...
                        print "	$(xml).find('cancelled').each(function(){
								var cancelled = $(this).text();
								if(cancelled==1)$('#v_cancelled').prop('checked',true);
							});";
                    }
                    else{
    ...
    function bind_project(e){
        if(e=='close'){
            ...
            $('#bind_project_holder').show();
        }
    }

    function view_company(e){
        if(e=='close'){
            $('#view_company_holder').hide();
            if(ctrl_id!='')$('#drag-and-drop-zone').dmUploader('destroy');
        }
        else if(e=='add'){
            if(check_form()){
                ...
                $.ajax({
                    ...
                    success: function(result){
                        if(result.success==1){
                            show_alert('成功创建公司！','close');
                            view_company(result.id);
                            filter_search(curr_page);
                        }
                        else{
                            alert(result.error);
            ...
            foreach($GLOBALS['company_fields'] as $key){
                if(	$key=="province" ||
                    ...
                    print "$('#v_cancelled').prop('checked', false);";
                }
                else{
                    print "$('#v_".$key."').val('');";
                }
...
<script type="text/javascript" src="../../public/js/dmuploader.js"></script>
