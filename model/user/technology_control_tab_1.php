			...
			<table id="sidebar_holder" width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td id="filter_holder">
						...
						<?php } ?>
						<!--technology-->
						<div id="filter_technology" class="list_holder">
							<span>
								<label for="all_technology">
									<input type="checkbox" class="check_all" id="all_technology">
									所有技术
								</label>
								<button onclick="filter_search();">
									筛选
...
<?php include("technology_control_tab_1_content.php"); ?>
