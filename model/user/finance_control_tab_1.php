			...
			<table id="sidebar_holder" width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td id="filter_holder">
						...
						<!--to_be_confirm-->
						<div id="filter_confirm" class="list_holder">
							<span>
								<label for="to_be_confirm">
									<input type="checkbox" id="to_be_confirm">
									审批待确认
								</label>
								<button onclick="filter_search();">
									筛选
						...
						<?php } ?>
						<!--finance-->
						<div id="filter_finance" class="list_holder">
							<span>
								<label for="all_finance">
									<input type="checkbox" class="check_all" id="all_finance">
									所有财务
								</label>
								<button onclick="filter_search();">
									筛选
...
<?php include("finance_control_tab_1_content.php"); ?>
