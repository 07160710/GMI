...
<table id="content_holder" class="ctrl_content" style="margin:52px 0 0 0;" border="0" cellpadding="0" cellspacing="0">
	<tr valign="top">
		<td>
			<?php include('platform_control_tab_1.php');?>
		</td>
	</tr>
</table>

<script>
var act_tab = '<?php print $_COOKIE['platform_tab'];?>';
var ctrl_id = '';
	ctrl_action = '';	
var post_url = 'platform_manage.php';
var curr_tab_panel = '';
var platform_sort_arr = new Array;
var curr_page = 1,
	page_span = 5;

$(function() {	
	if(act_tab==''){
		document.cookie = 'platform_tab=1';
		$('#tab_panel_1').show();
